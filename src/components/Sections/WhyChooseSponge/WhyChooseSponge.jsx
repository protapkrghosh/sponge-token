    ...
    <div className='xl:mt-[140px] lg:mt-[120px] md:mt-[100px] mt-[80px]'>
      <Container>
        ...
        <div className='lg:flex lg:gap-[30px]'>
          ...
          <div className='bg-[#071D4C] rounded-[20px] lg:mb-[0px] mb-[20px] lg:w-1/2'>
            ...
            <img className='2xl:w-[65%] xl:w-[78%] lg:w-[84%] md:w-[50%] w-[80%] mx-auto xl:pb-[56.89px] lg:pb-[50px] md:pb-[40px] pb-[35px]' src={whyChooseImg} alt="image" />
          </div>
