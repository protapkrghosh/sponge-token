            ...
            <div className='lg:w-[57%]'>
              <div className='space-y-7'>
                ...
                <div className='bg-[#0C2251] cusShadow p-10 rounded-[20px]'>
                  <h2 className='text-[#FDF44E] xl:text-[40px] lg:text-[35px] text-[24px] font-TTRoundsNeue font-bold'>1. Click on Buy Button</h2>
                ...
                {/* Card Two */}
                <div className='bg-[#0C2251] cusShadow p-10 rounded-[20px]'>
                  <h2 className='text-[#FDF44E] xl:text-[40px] lg:text-[35px] text-[24px] font-TTRoundsNeue font-bold'>2. Connect your wallet</h2>
                ...
                {/* Card Three */}
                <div className='bg-[#0C2251] cusShadow p-10 rounded-[20px]'>
                  <h2 className='text-[#FDF44E] xl:text-[40px] lg:text-[35px] text-[24px] font-TTRoundsNeue font-bold'>3. Choose Amount to Buy</h2>
            ...
            <div className='lg:w-[43%]'>
              ...
              <div>
                ...
                <div className='bg-[#0C2251] cusShadow p-10 rounded-[20px] mt-8 lg:mt-4 xl:w-[90%]'>
                  <h2 className='text-[#FDF44E] xl:text-[40px] lg:text-[35px] text-[24px] font-TTRoundsNeue font-bold xl:w-[85%] xl:leading-[43px] 2xl:leading-[48px] tracking-[0.96px]'>4. Buy SPONGE <span className='xl:pl-[48px]'>token</span></h2>
